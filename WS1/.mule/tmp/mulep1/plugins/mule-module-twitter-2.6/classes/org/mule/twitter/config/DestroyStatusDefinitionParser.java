...
import org.mule.twitter.processors.DestroyStatusMessageProcessor;
...
public class DestroyStatusDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public DestroyStatusDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(DestroyStatusMessageProcessor.class.getName());
