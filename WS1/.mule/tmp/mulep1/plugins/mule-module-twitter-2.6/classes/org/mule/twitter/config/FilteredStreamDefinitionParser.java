...
import org.mule.twitter.sources.FilteredStreamMessageSource;
...
public class FilteredStreamDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public FilteredStreamDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(FilteredStreamMessageSource.class.getName());
