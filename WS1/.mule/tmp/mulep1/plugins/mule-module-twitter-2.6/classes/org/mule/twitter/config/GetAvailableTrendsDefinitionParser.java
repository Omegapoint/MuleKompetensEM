...
import org.mule.twitter.processors.GetAvailableTrendsMessageProcessor;
...
public class GetAvailableTrendsDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public GetAvailableTrendsDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(GetAvailableTrendsMessageProcessor.class.getName());
