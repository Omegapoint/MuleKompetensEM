...
import org.mule.twitter.processors.GetHomeTimelineMessageProcessor;
...
public class GetHomeTimelineDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public GetHomeTimelineDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(GetHomeTimelineMessageProcessor.class.getName());
