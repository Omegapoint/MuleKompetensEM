...
import org.mule.twitter.processors.GetRetweetedByIDsMessageProcessor;
...
public class GetRetweetedByIDsDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public GetRetweetedByIDsDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(GetRetweetedByIDsMessageProcessor.class.getName());
