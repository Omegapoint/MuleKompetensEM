...
import org.mule.twitter.processors.GetRetweetedByMeMessageProcessor;
...
public class GetRetweetedByMeDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public GetRetweetedByMeDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(GetRetweetedByMeMessageProcessor.class.getName());
