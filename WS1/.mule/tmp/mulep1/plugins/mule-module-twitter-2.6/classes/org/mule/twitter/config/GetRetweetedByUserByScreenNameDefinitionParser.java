...
import org.mule.twitter.processors.GetRetweetedByUserByScreenNameMessageProcessor;
...
public class GetRetweetedByUserByScreenNameDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public GetRetweetedByUserByScreenNameDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(GetRetweetedByUserByScreenNameMessageProcessor.class.getName());
