...
import org.mule.twitter.processors.GetRetweetedByUserByUserIdMessageProcessor;
...
public class GetRetweetedByUserByUserIdDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public GetRetweetedByUserByUserIdDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(GetRetweetedByUserByUserIdMessageProcessor.class.getName());
