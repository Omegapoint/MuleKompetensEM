...
import org.mule.twitter.processors.GetRetweetedToUserByScreenNameMessageProcessor;
...
public class GetRetweetedToUserByScreenNameDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public GetRetweetedToUserByScreenNameDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(GetRetweetedToUserByScreenNameMessageProcessor.class.getName());
        String configRef = element.getAttribute("config-ref");
        if ((configRef!= null)&&(!StringUtils.isBlank(configRef))) {
            builder.addPropertyValue("moduleObject", configRef);
        }
        if ((element.getAttribute("screenName")!= null)&&(!StringUtils.isBlank(element.getAttribute("screenName")))) {
            builder.addPropertyValue("screenName", element.getAttribute("screenName"));
        }
