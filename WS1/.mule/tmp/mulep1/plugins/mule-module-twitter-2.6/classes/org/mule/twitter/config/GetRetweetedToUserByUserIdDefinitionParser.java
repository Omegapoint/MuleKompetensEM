...
import org.mule.twitter.processors.GetRetweetedToUserByUserIdMessageProcessor;
...
public class GetRetweetedToUserByUserIdDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public GetRetweetedToUserByUserIdDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(GetRetweetedToUserByUserIdMessageProcessor.class.getName());
