...
import org.mule.twitter.processors.GetRetweetsMessageProcessor;
...
public class GetRetweetsDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public GetRetweetsDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(GetRetweetsMessageProcessor.class.getName());
