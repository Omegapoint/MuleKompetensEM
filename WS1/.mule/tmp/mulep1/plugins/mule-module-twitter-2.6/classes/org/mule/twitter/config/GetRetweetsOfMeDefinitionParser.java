...
import org.mule.twitter.processors.GetRetweetsOfMeMessageProcessor;
...
public class GetRetweetsOfMeDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public GetRetweetsOfMeDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(GetRetweetsOfMeMessageProcessor.class.getName());
