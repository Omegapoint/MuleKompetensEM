...
import org.mule.twitter.processors.GetUserTimelineByScreenNameMessageProcessor;
...
public class GetUserTimelineByScreenNameDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public GetUserTimelineByScreenNameDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(GetUserTimelineByScreenNameMessageProcessor.class.getName());
