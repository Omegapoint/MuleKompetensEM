...
import org.mule.twitter.processors.GetUserTimelineByUserIdMessageProcessor;
...
public class GetUserTimelineByUserIdDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public GetUserTimelineByUserIdDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(GetUserTimelineByUserIdMessageProcessor.class.getName());
