...
import org.mule.twitter.processors.GetUserTimelineMessageProcessor;
...
public class GetUserTimelineDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public GetUserTimelineDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(GetUserTimelineMessageProcessor.class.getName());
