...
import org.mule.twitter.processors.RequestAuthorizationMessageProcessor;
...
public class RequestAuthorizationDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public RequestAuthorizationDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(RequestAuthorizationMessageProcessor.class.getName());
