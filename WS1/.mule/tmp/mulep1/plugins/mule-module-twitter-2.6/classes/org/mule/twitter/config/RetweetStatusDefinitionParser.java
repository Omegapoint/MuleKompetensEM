...
import org.mule.twitter.processors.RetweetStatusMessageProcessor;
...
public class RetweetStatusDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public RetweetStatusDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(RetweetStatusMessageProcessor.class.getName());
