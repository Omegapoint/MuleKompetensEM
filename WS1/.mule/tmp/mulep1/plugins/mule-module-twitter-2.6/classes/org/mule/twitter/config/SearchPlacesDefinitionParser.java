...
import org.mule.twitter.processors.SearchPlacesMessageProcessor;
...
public class SearchPlacesDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public SearchPlacesDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(SearchPlacesMessageProcessor.class.getName());
        ...
        if ((element.getAttribute("ip")!= null)&&(!StringUtils.isBlank(element.getAttribute("ip")))) {
            builder.addPropertyValue("ip", element.getAttribute("ip"));
        }
