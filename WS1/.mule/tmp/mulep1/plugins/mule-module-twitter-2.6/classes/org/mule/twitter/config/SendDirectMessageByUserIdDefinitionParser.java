...
import org.mule.twitter.processors.SendDirectMessageByUserIdMessageProcessor;
...
public class SendDirectMessageByUserIdDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public SendDirectMessageByUserIdDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(SendDirectMessageByUserIdMessageProcessor.class.getName());
