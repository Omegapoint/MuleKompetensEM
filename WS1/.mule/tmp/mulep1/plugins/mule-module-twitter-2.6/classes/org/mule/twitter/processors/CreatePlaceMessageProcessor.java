    ...
    implements FlowConstructAware, MuleContextAware, Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
    ...
    private Object containedWithin;
    private String _containedWithinType;
    private Object token;
    private String _tokenType;
    private Object latitude;
    private Double _latitudeType;
    private Object longitude;
    private Double _longitudeType;
    private Object streetAddress;
    private String _streetAddressType;
    private static Logger logger = LoggerFactory.getLogger(CreatePlaceMessageProcessor.class);
    /**
     * Module object
     * 
     */
        ...
        throws MuleException
    {
        ...
        if (moduleObject instanceof String) {
            ...
            if (_castedModuleObject == null) {
                throw new MessagingException(CoreMessages.failedToCreate("createPlace"), event, new RuntimeException("Cannot find the configuration specified by the config-ref attribute."));
            }
        } else {
            _castedModuleObject = ((TwitterConnectorLifecycleAdapter) moduleObject);
        }
        try {
            String _transformedName = ((String) evaluateAndTransform(_muleMessage, CreatePlaceMessageProcessor.class.getDeclaredField("_nameType").getGenericType(), null, name));
            String _transformedContainedWithin = ((String) evaluateAndTransform(_muleMessage, CreatePlaceMessageProcessor.class.getDeclaredField("_containedWithinType").getGenericType(), null, containedWithin));
            String _transformedToken = ((String) evaluateAndTransform(_muleMessage, CreatePlaceMessageProcessor.class.getDeclaredField("_tokenType").getGenericType(), null, token));
            Double _transformedLatitude = ((Double) evaluateAndTransform(_muleMessage, CreatePlaceMessageProcessor.class.getDeclaredField("_latitudeType").getGenericType(), null, latitude));
            Double _transformedLongitude = ((Double) evaluateAndTransform(_muleMessage, CreatePlaceMessageProcessor.class.getDeclaredField("_longitudeType").getGenericType(), null, longitude));
            String _transformedStreetAddress = ((String) evaluateAndTransform(_muleMessage, CreatePlaceMessageProcessor.class.getDeclaredField("_streetAddressType").getGenericType(), null, streetAddress));
            retryCount.getAndIncrement();
            Object resultPayload;
            resultPayload = _castedModuleObject.createPlace(_transformedName, _transformedContainedWithin, _transformedToken, _transformedLatitude, _transformedLongitude, _transformedStreetAddress);
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("createPlace"), event, e);
        }
    }
