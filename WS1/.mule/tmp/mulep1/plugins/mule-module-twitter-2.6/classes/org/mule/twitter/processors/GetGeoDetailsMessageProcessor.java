...
/**
 * GetGeoDetailsMessageProcessor invokes the {@link org.mule.twitter.TwitterConnector#getGeoDetails(java.lang.String)} method in {@link TwitterConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
public class GetGeoDetailsMessageProcessor
    implements FlowConstructAware, MuleContextAware, Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{

    private Object id;
    private String _idType;
    private static Logger logger = LoggerFactory.getLogger(GetGeoDetailsMessageProcessor.class);
    /**
     * Module object
     * 
     */
        ...
        throws MuleException
    {
        ...
        if (moduleObject instanceof String) {
            ...
            if (_castedModuleObject == null) {
                throw new MessagingException(CoreMessages.failedToCreate("getGeoDetails"), event, new RuntimeException("Cannot find the configuration specified by the config-ref attribute."));
            }
        } else {
            _castedModuleObject = ((TwitterConnectorLifecycleAdapter) moduleObject);
        }
        try {
            String _transformedId = ((String) evaluateAndTransform(_muleMessage, GetGeoDetailsMessageProcessor.class.getDeclaredField("_idType").getGenericType(), null, id));
            retryCount.getAndIncrement();
            Object resultPayload;
            resultPayload = _castedModuleObject.getGeoDetails(_transformedId);
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("getGeoDetails"), event, e);
        }
    }
