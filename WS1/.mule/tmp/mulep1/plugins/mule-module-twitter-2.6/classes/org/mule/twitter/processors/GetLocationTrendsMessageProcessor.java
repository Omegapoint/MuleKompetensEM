...
/**
 * GetLocationTrendsMessageProcessor invokes the {@link org.mule.twitter.TwitterConnector#getLocationTrends(int)} method in {@link TwitterConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
public class GetLocationTrendsMessageProcessor
    implements FlowConstructAware, MuleContextAware, Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{

    private Object woeid;
    private int _woeidType;
    private static Logger logger = LoggerFactory.getLogger(GetLocationTrendsMessageProcessor.class);
    /**
     * Module object
     * 
     */
     ...
     * @param value Value to set
     */
    public void setWoeid(Object value) {
        this.woeid = value;
    }
        ...
        throws MuleException
    {
        ...
        if (moduleObject instanceof String) {
            ...
            if (_castedModuleObject == null) {
                throw new MessagingException(CoreMessages.failedToCreate("getLocationTrends"), event, new RuntimeException("Cannot find the configuration specified by the config-ref attribute."));
            }
        } else {
            _castedModuleObject = ((TwitterConnectorLifecycleAdapter) moduleObject);
        }
        try {
            Integer _transformedWoeid = ((Integer) evaluateAndTransform(_muleMessage, GetLocationTrendsMessageProcessor.class.getDeclaredField("_woeidType").getGenericType(), null, woeid));
            retryCount.getAndIncrement();
            Object resultPayload;
            resultPayload = _castedModuleObject.getLocationTrends(_transformedWoeid);
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("getLocationTrends"), event, e);
        }
    }
