...
/**
 * GetPublicTimelineMessageProcessor invokes the {@link org.mule.twitter.TwitterConnector#getPublicTimeline()} method in {@link TwitterConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
public class GetPublicTimelineMessageProcessor
    implements FlowConstructAware, MuleContextAware, Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{

    private static Logger logger = LoggerFactory.getLogger(GetPublicTimelineMessageProcessor.class);
    /**
     * Module object
     * 
     */
        ...
        throws MuleException
    {
        ...
        if (moduleObject instanceof String) {
            ...
            if (_castedModuleObject == null) {
                throw new MessagingException(CoreMessages.failedToCreate("getPublicTimeline"), event, new RuntimeException("Cannot find the configuration specified by the config-ref attribute."));
            }
        } else {
        ...
        try {
            ...
            resultPayload = _castedModuleObject.getPublicTimeline();
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("getPublicTimeline"), event, e);
        }
    }
