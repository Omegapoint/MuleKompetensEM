    ...
    implements FlowConstructAware, MuleContextAware, Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
    ...
    private Long _maxIdType;
    private Object rpp;
    private Integer _rppType;
    private Object page;
    private Integer _pageType;
    private Object since;
    private String _sinceType;
    private Object sinceId;
    private Long _sinceIdType;
    private Object geocode;
    private String _geocodeType;
    private Object radius;
    private String _radiusType;
    private Object unit;
    private String _unitType;
    private Object until;
    private String _untilType;
    private Object resultType;
    private String _resultTypeType;
    private static Logger logger = LoggerFactory.getLogger(SearchMessageProcessor.class);
    /**
     * Module object
     * 
     */
     ...
     * @param value Value to set
     */
    public void setRpp(Object value) {
        this.rpp = value;
    }
        ...
        throws MuleException
    {
        ...
        if (moduleObject instanceof String) {
            ...
            if (_castedModuleObject == null) {
                throw new MessagingException(CoreMessages.failedToCreate("search"), event, new RuntimeException("Cannot find the configuration specified by the config-ref attribute."));
            }
        } else {
            _castedModuleObject = ((TwitterConnectorLifecycleAdapter) moduleObject);
        }
        try {
            String _transformedQuery = ((String) evaluateAndTransform(_muleMessage, SearchMessageProcessor.class.getDeclaredField("_queryType").getGenericType(), null, query));
            String _transformedLang = ((String) evaluateAndTransform(_muleMessage, SearchMessageProcessor.class.getDeclaredField("_langType").getGenericType(), null, lang));
            String _transformedLocale = ((String) evaluateAndTransform(_muleMessage, SearchMessageProcessor.class.getDeclaredField("_localeType").getGenericType(), null, locale));
            Long _transformedMaxId = ((Long) evaluateAndTransform(_muleMessage, SearchMessageProcessor.class.getDeclaredField("_maxIdType").getGenericType(), null, maxId));
            Integer _transformedRpp = ((Integer) evaluateAndTransform(_muleMessage, SearchMessageProcessor.class.getDeclaredField("_rppType").getGenericType(), null, rpp));
            Integer _transformedPage = ((Integer) evaluateAndTransform(_muleMessage, SearchMessageProcessor.class.getDeclaredField("_pageType").getGenericType(), null, page));
            String _transformedSince = ((String) evaluateAndTransform(_muleMessage, SearchMessageProcessor.class.getDeclaredField("_sinceType").getGenericType(), null, since));
            Long _transformedSinceId = ((Long) evaluateAndTransform(_muleMessage, SearchMessageProcessor.class.getDeclaredField("_sinceIdType").getGenericType(), null, sinceId));
            String _transformedGeocode = ((String) evaluateAndTransform(_muleMessage, SearchMessageProcessor.class.getDeclaredField("_geocodeType").getGenericType(), null, geocode));
            String _transformedRadius = ((String) evaluateAndTransform(_muleMessage, SearchMessageProcessor.class.getDeclaredField("_radiusType").getGenericType(), null, radius));
            String _transformedUnit = ((String) evaluateAndTransform(_muleMessage, SearchMessageProcessor.class.getDeclaredField("_unitType").getGenericType(), null, unit));
            String _transformedUntil = ((String) evaluateAndTransform(_muleMessage, SearchMessageProcessor.class.getDeclaredField("_untilType").getGenericType(), null, until));
            String _transformedResultType = ((String) evaluateAndTransform(_muleMessage, SearchMessageProcessor.class.getDeclaredField("_resultTypeType").getGenericType(), null, resultType));
            retryCount.getAndIncrement();
            Object resultPayload;
            resultPayload = _castedModuleObject.search(_transformedQuery, _transformedLang, _transformedLocale, _transformedMaxId, _transformedRpp, _transformedPage, _transformedSince, _transformedSinceId, _transformedGeocode, _transformedRadius, _transformedUnit, _transformedUntil, _transformedResultType);
