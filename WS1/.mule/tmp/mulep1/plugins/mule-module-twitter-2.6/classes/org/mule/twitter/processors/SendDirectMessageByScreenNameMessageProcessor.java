...
/**
 * SendDirectMessageByScreenNameMessageProcessor invokes the {@link org.mule.twitter.TwitterConnector#sendDirectMessageByScreenName(java.lang.String, java.lang.String)} method in {@link TwitterConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
public class SendDirectMessageByScreenNameMessageProcessor
    implements FlowConstructAware, MuleContextAware, Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
    ...
    private static Logger logger = LoggerFactory.getLogger(SendDirectMessageByScreenNameMessageProcessor.class);
    /**
     * Module object
     * 
     */
        ...
        throws MuleException
    {
        ...
        if (moduleObject instanceof String) {
            ...
            if (_castedModuleObject == null) {
                throw new MessagingException(CoreMessages.failedToCreate("sendDirectMessageByScreenName"), event, new RuntimeException("Cannot find the configuration specified by the config-ref attribute."));
            }
        } else {
            _castedModuleObject = ((TwitterConnectorLifecycleAdapter) moduleObject);
        }
        try {
            String _transformedScreenName = ((String) evaluateAndTransform(_muleMessage, SendDirectMessageByScreenNameMessageProcessor.class.getDeclaredField("_screenNameType").getGenericType(), null, screenName));
            String _transformedMessage = ((String) evaluateAndTransform(_muleMessage, SendDirectMessageByScreenNameMessageProcessor.class.getDeclaredField("_messageType").getGenericType(), null, message));
            retryCount.getAndIncrement();
            Object resultPayload;
            resultPayload = _castedModuleObject.sendDirectMessageByScreenName(_transformedScreenName, _transformedMessage);
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("sendDirectMessageByScreenName"), event, e);
        }
    }
