...
/**
 * UpdateStatusMessageProcessor invokes the {@link org.mule.twitter.TwitterConnector#updateStatus(java.lang.String, long, java.lang.Double, java.lang.Double)} method in {@link TwitterConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
public class UpdateStatusMessageProcessor
    implements FlowConstructAware, MuleContextAware, Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
    ...
    private long _inReplyToType;
    private Object latitude;
    private Double _latitudeType;
    private Object longitude;
    private Double _longitudeType;
    private static Logger logger = LoggerFactory.getLogger(UpdateStatusMessageProcessor.class);
    /**
     * Module object
     * 
     */
     ...
     * @param value Value to set
     */
    public void setInReplyTo(Object value) {
        ...
        throws MuleException
    {
        ...
        if (moduleObject instanceof String) {
            ...
            if (_castedModuleObject == null) {
                throw new MessagingException(CoreMessages.failedToCreate("updateStatus"), event, new RuntimeException("Cannot find the configuration specified by the config-ref attribute."));
            }
        } else {
            _castedModuleObject = ((TwitterConnectorLifecycleAdapter) moduleObject);
        }
        try {
            String _transformedStatus = ((String) evaluateAndTransform(_muleMessage, UpdateStatusMessageProcessor.class.getDeclaredField("_statusType").getGenericType(), null, status));
            Long _transformedInReplyTo = ((Long) evaluateAndTransform(_muleMessage, UpdateStatusMessageProcessor.class.getDeclaredField("_inReplyToType").getGenericType(), null, inReplyTo));
            Double _transformedLatitude = ((Double) evaluateAndTransform(_muleMessage, UpdateStatusMessageProcessor.class.getDeclaredField("_latitudeType").getGenericType(), null, latitude));
            Double _transformedLongitude = ((Double) evaluateAndTransform(_muleMessage, UpdateStatusMessageProcessor.class.getDeclaredField("_longitudeType").getGenericType(), null, longitude));
            retryCount.getAndIncrement();
            Object resultPayload;
            resultPayload = _castedModuleObject.updateStatus(_transformedStatus, _transformedInReplyTo, _transformedLatitude, _transformedLongitude);
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("updateStatus"), event, e);
        }
    }
