...
/**
 * FirehoseStreamMessageSource wraps {@link org.mule.twitter.TwitterConnector#firehoseStream(int, org.mule.api.callback.SourceCallback)} method in {@link TwitterConnector } as a message source capable of generating Mule events.  The POJO's method is invoked in its own thread.
 * 
 */
public class FirehoseStreamMessageSource
        ...
        try {
            if (moduleObject instanceof String) {
                ...
                if (castedModuleObject == null) {
                    throw new MessagingException(CoreMessages.failedToCreate("firehoseStream"), ((MuleEvent) null), new RuntimeException("Cannot find the configuration specified by the config-ref attribute."));
                }
            } else {
            ...
            castedModuleObject.firehoseStream(transformedCount, this);
