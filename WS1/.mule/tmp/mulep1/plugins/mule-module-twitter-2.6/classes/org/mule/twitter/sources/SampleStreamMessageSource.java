...
/**
 * SampleStreamMessageSource wraps {@link org.mule.twitter.TwitterConnector#sampleStream(org.mule.api.callback.SourceCallback)} method in {@link TwitterConnector } as a message source capable of generating Mule events.  The POJO's method is invoked in its own thread.
 * 
 */
public class SampleStreamMessageSource
    implements Runnable, SourceCallback, FlowConstructAware, MuleContextAware, Initialisable, Startable, Stoppable, MessageSource
{
    ...
    public void run() {
        ...
        try {
            ...
            castedModuleObject.sampleStream(this);
