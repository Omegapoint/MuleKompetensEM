        ...
        try {
            if (moduleObject instanceof String) {
                ...
                if (castedModuleObject == null) {
                    throw new MessagingException(CoreMessages.failedToCreate("userStream"), ((MuleEvent) null), new RuntimeException("Cannot find the configuration specified by the config-ref attribute."));
                }
            } else {
            ...
            castedModuleObject.userStream(transformedKeywords, this);
